...
export const listingWatermarkRenderVersion = "v13-portrait-rounded";
import { LISTING_IMAGE_SIZE, LISTING_IMAGE_WIDTH, listingImageBox, portraitRotation, listingImageCornerRadius } from "./listing-image-layout";
