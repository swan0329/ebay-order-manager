...
export async function getProcurementSafetySummary() {
  ...
  }, select: { stockQuantity: true, salePrice: true, ebayPrice: true, ebayLastSyncedPrice: true, lastUploadedAt: true, sku: true, pocamarketId: true, pocamarketSyncedAt: true, pocamarketLastAttemptAt: true } });
