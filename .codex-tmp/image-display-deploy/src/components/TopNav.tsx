...
const sections:NavSection[]=[
  {label:"업무 관리",items:[
    ...
    {href:"/products",label:"재고관리",icon:PackageOpen,matchPrefixes:["/products","/inventory","/inventory/movements"],excludePrefixes:["/inventory/photo-card-match","/products/image-workbench","/products/ai-image-work","/products/watermark-settings"]},
