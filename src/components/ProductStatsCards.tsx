...
export function ProductStatsCards({
  ...
  const cards = [
    ...
    {
      label: "활성 리스팅",
      count: stats.activeListingCount,
      description: `단품 ${stats.activeStandaloneListingCount} + 옵션묶음 ${stats.activeVariationListingCount}`,
      href: "/listing-upload/variation-groups",
      icon: PackageCheck,
    ...
    },
    {
      ...
      description: `단품 ${stats.standaloneSellingCount} + 묶음옵션 ${stats.variationSellingCount}${stats.duplicateSellingCount ? ` · 중복 ${stats.duplicateSellingCount}` : ""}`,
    ...
    {
      label: "묶음 공급불가",
      count: stats.variationStopRequiredCount,
      description: "옵션 판매중 · 내 재고·포카 매물 없음 · 묶음 수정 필요",
      href: statsHref(pageSize, "variation_stop_required"),
      icon: AlertTriangle,
      className: "border-fuchsia-300 bg-fuchsia-50 text-fuchsia-900 hover:bg-fuchsia-100",
    },
    {
      label: "품절",
