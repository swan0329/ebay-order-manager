    ...
    try {
      ...
      setMessage(
        savedPrice === null
          ...
          : `${candidate.sku} 가격 후보 $${savedPrice} 저장됨 — 가격관리에서 최종가를 확정해야 채널에 반영됩니다.`,
      );
    } catch (error) {
  ...
  return (
    ...
    >
      ...
      <div className="mt-3 space-y-1 text-sm">
        ...
        <div className="flex items-center justify-between gap-2">
          <span className="whitespace-nowrap text-zinc-600">가격 후보 $</span>
          <div className="inline-flex items-center gap-1">
            <input
              value={priceInput}
              onClick={(event) => event.stopPropagation()}
              ...
              title="가격 후보(USD)입니다. 저장 후 가격관리에서 최종가를 확정해야 판매 채널에 반영됩니다."
